...
REM
REM Generated by Vivado on Thu Jun 02 02:07:38 +0800 2022
...
echo "xvhdl --incr --relax -prj tb_towords_vhdl.prj"
call xvhdl  --incr --relax -prj tb_towords_vhdl.prj -log xvhdl.log
